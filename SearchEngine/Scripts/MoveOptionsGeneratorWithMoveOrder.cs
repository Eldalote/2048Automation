...
{
    public static class MoveOptionsGeneratorWithMoveOrder
    {


        public static List<PlayerMoveOption> GeneratePlayerMoveOptionsWithMoveOrder(HexBoard startBoard, ulong startScore, int firstDirection)
        {
        ...
        public static List<RandomPlacementOption> RandomPlacementOptionsWithMoveOrder(HexBoard startBoard, ulong startScore, int firstPlacement)
        {
