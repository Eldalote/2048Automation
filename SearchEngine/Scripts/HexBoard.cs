...
namespace SearchEngine.Scripts
{
    public struct HexBoard
    {
        ...
        public ulong LSB
        {
            get { return ulongArray[0]; }
            set { ulongArray[0] = value; }
        }
        // Ulong containing the most significant bits of each space.
        public ulong MSB
        {
            get { return ulongArray[1]; }
            set { ulongArray[1] = value; }
        }

        public HexBoard(ulong LSB, ulong MSB)
        {
            ulongArray = new ulong[2] { LSB, MSB };
        }
        public HexBoard()
        {
